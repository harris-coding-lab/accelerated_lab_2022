---
title: "Accelerated Coding Lab: Data manipulation with `dplyr`"
author: "Ari Anisfeld"
date: "09-04-2022"
urlcolor: blue
output:
...
We'll work with the following [`data set`](https://github.com/harris-coding-lab/harris-coding-lab.github.io/blob/master/fall_labs/reading-files/data/area_report_by_year.xlsx?raw=true). Download it and put the data in the appropriate folder. The data comes from the [NY Fed](https://www.newyorkfed.org/microeconomics/databank.html)
...
Try running this code locally on your computer! If it fails, the csv is [here](https://github.com/harris-coding-lab/harris-coding-lab.github.io/blob/master/fall_labs/reading-files/data/student_loan_debt.csv) and you can load it now.
...
1. The data is stored in exactly the same way as the student loan data. This implies you can reuse the code from before with a few (precisely 2) modifications. Copy and paste your code from before and make the modifications. The  result looks like this:
