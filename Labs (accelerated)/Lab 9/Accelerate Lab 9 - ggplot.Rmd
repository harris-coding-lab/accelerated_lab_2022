...
library(haven)
library(readxl)
college_recent_grads <- read_dta('~/Downloads/Module_5_Data/recent_college_grads.dta')

co <- read_csv("https://raw.githubusercontent.com/fivethirtyeight/data/master/college-majors/recent-grads.csv")
```
