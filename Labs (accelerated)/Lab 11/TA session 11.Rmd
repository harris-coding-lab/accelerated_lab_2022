---
title: "TA Session 11: Grouped Analysis"
...
# Background and data (read before TA session)
...
1. For the problem above, your group members tried the following code. Explain why the frequencies are all 1.^[Hint: This is a lesson about `group_by()`!]
